/*+----------------------------------------------------------------------
 ...
 ||                  Node getTempNode() -- Returns the temp node data point
 ...
 ||                  ThreeNode getTempChild()  -- Returns reference to the temp child ("most left child")
 ...
 ||                  void setTempNode(Node key) -- Sets a temporary data point
 ...
 ||                  void setTempChild(ThreeNode child) -- Sets the reference for the temp child ("most left child")
...
public class ThreeNode {
    ...
    private Node tempNode;               //temp Node data for splitting threenodes
    ...
    private ThreeNode tempChild;                //"Temporary child (considered the most left child)"
    ...
    *-------------------------------------------------------------------*/
    ...
    |  Method getTempNode
    |
    |  Purpose:  Return the temp node (contains data)
    |
    |  Pre-condition:  Temp node can be null, just needs to be initialized
    |
    ...
    *-------------------------------------------------------------------*/
    ...
    |  Method getTempChild
    |
    |  Purpose:  Return the temp child of the threenode.
    |
    |  Pre-condition:  ThreeNode should exist or be null.
    |
    |  Post-condition: Temp child is returned
    |
    |  Parameters: None
    |
    |  Returns:  ThreeNode
    *-------------------------------------------------------------------*/
    public ThreeNode getTempChild() {
    ...
    *-------------------------------------------------------------------*/
    ...
    |  Method setTempNode
    |
    |  Purpose:  Update the temp node's data information.
    |
    |  Pre-condition:  Node should exist or be null
    |
    |  Post-condition: Temp Node data is changed
    |
    |  Parameters: Node key -- contains the node information
    |
    |  Returns:  Nothing
    *-------------------------------------------------------------------*/
    public void setTempNode(Node key) 
    {
        this.tempNode = key;
    }
    ...
    *-------------------------------------------------------------------*/
    ...
    |  Method setTempChild
    |
    |  Purpose:  Update the temp child reference.
    |
    |  Pre-condition:  ThreeNode should exist or be null
    |
    |  Post-condition: Temp Child reference is changed
    |
    |  Parameters: ThreeNode child -- contains the reference to a new child
    |
    |  Returns:  Nothing
    *-------------------------------------------------------------------*/
    public void setTempChild(ThreeNode child) 
    {
